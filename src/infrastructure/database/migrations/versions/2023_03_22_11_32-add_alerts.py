...
Revision ID: 1adbcf5d00f5
Revises: 651d290bd7b7
Create Date: 2023-03-22 11:32:58.589902
...
revision = "1adbcf5d00f5"
down_revision = "651d290bd7b7"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("specific_answer", sa.Text(), nullable=False),
