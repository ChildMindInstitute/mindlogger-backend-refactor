...
def upgrade() -> None:
    ...
    op.add_column(
        "answers", sa.Column("target_subject_id", sa.Text(), nullable=False)
    )
    op.add_column(
        "answers", sa.Column("source_subject_id", sa.Text(), nullable=False)
    )
    op.add_column(
    ...
    op.create_unique_constraint(
        op.f("uq_answers_relation"), "answers", ["relation"]
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f("uq_answers_relation"), "answers", type_="unique")
