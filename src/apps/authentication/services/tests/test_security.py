...
class TestAuthenticationService:
    ...
    async def test_update_user_last_seen_is_none(self, session: AsyncSession, user_not_seen: User, mocker: MockerFixture
    ) -> None:
        mock_ = mocker.patch("apps.users.cruds.user.UsersCRUD.update_last_seen_by_id")
    ...
    async def test_update_user_last_seen_too_soon(self, session: AsyncSession, recent_user: User, mocker: MockerFixture
    ) -> None:
        mock_ = mocker.patch("apps.users.cruds.user.UsersCRUD.update_last_seen_by_id")
