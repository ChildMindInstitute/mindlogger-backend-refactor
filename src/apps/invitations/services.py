...
from apps.applets.domain import Role, RoleLevel, UserAppletAccess
...
class InvitationsService:
    ...
    async def _validate_invitation(
        ...
        is_exist = await AppletService().exist_by_id(
        ...
        elif RoleLevel.by_role(Role(role)) > RoleLevel.by_role(
