...
class TestInvite(BaseTest):
    ...
    async def test_admin_invite_reviewer_success(self, client, invitation_reviewer_data, tom, user):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        response = await client.post(
    ...
    async def test_manager_invite_reviewer_success(self, client, invitation_reviewer_data):
        await client.login(self.login_url, "lucy@gmail.com", "Test123")
        response = await client.post(
            self.invite_reviewer_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1"),
            invitation_reviewer_data,
    ...
    async def test_coordinator_invite_reviewer_success(self, client, invitation_reviewer_data):
        await client.login(self.login_url, "bob@gmail.com", "Test1234!")
        response = await client.post(
            self.invite_reviewer_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1"),
            invitation_reviewer_data,
    ...
    async def test_send_invitation_to_reviewer_invitation_already_approved(self, client, invitation_reviewer_data, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        # send an invite
        response = await client.post(
            self.invite_reviewer_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1"),
    ...
    async def test_invite_reviewer_with_respondent_does_not_exist(self, client, invitation_reviewer_data, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        invitation_reviewer_data.subjects = ["00000000-0000-0000-0000-000000000000"]
        response = await client.post(
            self.invite_reviewer_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1"),
            invitation_reviewer_data,
        )
    ...
    async def test_invite_and_accept_invitation_as_respondent(
        self, client, session, invitation_respondent_data
    ):
