...
class TestLink(BaseTest):
    ...
    async def test_applet_access_link_create_by_admin(self, client):
        ...
        response = await client.post(
            self.access_link_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b2"),
            data=data,
        )
        ...
        response = await client.get(self.access_link_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b2"))
    ...
    async def test_applet_access_link_create_by_manager(self, client):
        ...
        response = await client.delete(self.access_link_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1"))
        assert response.status_code == 204

        data = {"require_login": True}
        response = await client.post(
            self.access_link_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1"),
            data=data,
        )
    ...
    async def test_applet_access_link_get(self, client):
        ...
        response = await client.get(self.access_link_url.format(applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1"))
    ...
    async def test_applet_access_link_create_for_anonym(self, client):
        ...
        resp = await client.delete(self.access_link_url.format(applet_id=applet_id))
