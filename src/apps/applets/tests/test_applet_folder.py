...
class TestAppletMoveToFolder(BaseTest):
    ...
    async def test_move_to_folder(self, session, client, tom):
    ...
    async def test_invalid_applet_move_to_folder(self, client, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        data = dict(
    ...
    async def test_move_to_not_accessible_folder(self, client, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        data = dict(
            applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1",
    ...
    async def test_move_not_accessible_applet_to_folder(self, client, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        data = dict(
    ...
    async def test_remove_from_folder(self, session, client, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
    ...
    async def test_move_to_folder__folder_does_not_exists(self, client, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        data = dict(
            applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1",
    ...
    async def test_move_to_folder_applet_already_moved(self, session, client, tom):
        await client.login(self.login_url, tom.email_encrypted, "Test1234!")
        data = dict(
            applet_id="92917a56-d586-4613-b7aa-991f2c4b15b1",
            folder_id="ecf66358-a717-41a7-8027-807374307731",
