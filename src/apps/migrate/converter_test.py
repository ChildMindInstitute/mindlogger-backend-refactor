...
# jld_url = 'https://raw.githubusercontent.com/hotavocado/HBN_EMA_NIMH2/master/protocols/EMA_HBN_NIMH2/README.md'
...
async def main():
    ...
    doc = get_json("src/apps/migrate/applet_test_ld.json")
