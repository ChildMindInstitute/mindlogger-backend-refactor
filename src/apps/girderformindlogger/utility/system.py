...
def _computeSlowStatus(process, status, db):
    ...
    status["mongoDbPath"] = getDbConnection().admin.command("getCmdLineOpts")[
        "parsed"
    ]["storage"]["dbPath"]
    ...
    for conn in process.connections():
        ...
        connDict["family"] = connFamily.get(
            connDict["family"], connDict["family"]
        )
