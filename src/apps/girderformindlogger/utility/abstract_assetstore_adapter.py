...
class FileHandle(object):
    ...
    :type adapter: girderformindlogger.utility.abstract_assetstore_adapter.AbstractAssetstoreAdapter
    """
    ...
    def seek(self, offset, whence=os.SEEK_SET):
        ...
        if self._pos != oldPos:
            self._prev = []
            self._stream = self._adapter.downloadFile(
                self._file, offset=self._pos, headers=False
            )()
...
class AbstractAssetstoreAdapter(object):
    ...
    def uploadChunk(self, upload, chunk):
        ...
        raise NotImplementedError(
            "Must override processChunk in %s." % self.__class__.__name__
        )
    ...
    def deleteFile(self, file):
        ...
        """
        raise NotImplementedError(
            "Must override deleteFile in %s." % self.__class__.__name__
        )
    ...
    def downloadFile(
        ...
        **kwargs,
        ...
        """
        raise NotImplementedError(
            "Must override downloadFile in %s." % self.__class__.__name__
        )
    ...
    def findInvalidFiles(
        ...
        **kwargs,
        ...
        """
        raise NotImplementedError(
            "Must override findInvalidFiles in %s." % self.__class__.__name__
        )
    ...
    def setContentHeaders(
        self, file, offset, endByte, contentDisposition=None
    ):
        """
    ...
    def checkUploadSize(self, upload, chunkSize):
        ...
        if upload["received"] + chunkSize != upload[
            "size"
    ...
    def cancelUpload(self, upload):
        ...
        """
        raise NotImplementedError(
            "Must override cancelUpload in %s." % self.__class__.__name__
        )
