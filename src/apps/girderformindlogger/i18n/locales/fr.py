locale = {
    ...
    # ERRORS.
    "error_invalid_email": "Veuillez indiquer une adresse électronique valide",
    "error_invalid_password": "Mot de passe incorrect pour {user} si cet utilisateur existe",
    # APPLETS.
