...
class Assetstore(Model):
    ...
    def validate(self, doc):
        ...
        adapter = assetstore_utilities.getAssetstoreAdapter(
            doc, instance=False
        )
    ...
    def addComputedInfo(self, assetstore):
        ...
        assetstore["hasFiles"] = (
            File().findOne({"assetstoreId": assetstore["_id"]}) is not None
        )
    ...
    def createGridFsAssetstore(
        self, name, db, mongohost=None, replicaset=None
    ):
        return self.save(
            {
    ...
    def importData(
        self, assetstore, parent, parentType, params, progress, user, **kwargs
    ):
        """
